  ...
  return (
    <nav className="glass-panel rounded-2xl p-4 mb-6 flex items-center justify-between fade-in">
      ...
      {showNewUploadButton && (
        <button
          onClick={onNewUpload}
          className="flex items-center space-x-2 px-4 py-2 rounded-xl bg-white border border-gray-200 text-gray-700 hover:bg-gray-50 hover:border-gray-300 transition-all duration-200 shadow-sm"
        >
